...
var instrucciones = [
  ...
  "Puedes mover las piezas la cantidad de veces que quieras",
  "Si no resuelves el rompecabezas algo malo podría pasarte =)"
];
var movimientos = [];
...
function chequearSiGano() {
  ...
  return coincidencias === 9;
}

// Implementar alguna forma de mostrar un cartel que avise que ganaste el juego
function mostrarCartelGanador() {
  if (chequearSiGano() === true) {
    alert("Felicitaciones, has resuelto el rompecabezas!!!");
  }
}
